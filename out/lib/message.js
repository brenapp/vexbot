...
function removeMessageHandler(index) {
    handlers[index] = function () { return false; };
}
function addOneTimeMessageHandler(handler) {
    var index = addMessageHandler(function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, handler(message)];
                    case 1:
                        res = _a.sent();
                        if (res)
...
exports.addOneTimeMessageHandler = addOneTimeMessageHandler;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    i = 0;
                    _a.label = 1;
                case 1: return [4, handlers[i++](message)];
                case 2:
                    if (!(!(_a.sent()) && i < handlers.length)) return [3, 3];
                    return [3, 1];
                case 3: return [2, handlers[i]];
            }
        });
    });
}
