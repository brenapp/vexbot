...
export var elizaQuits = ["bye", "goodbye", "done", "exit", "quit"];

export var elizaPres = [
  "dont",
  "don't",
  "cant",
  "can't",
...
export var elizaPostTransforms = [
  / old old/g,
  " old",
